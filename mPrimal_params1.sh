...
module load python
source g6k/activate
python3 -u exp_successprob.py c=3 r=59 m=60 sigma=11 q=48000 betaQ=${betaQ} structured=${structured} \
    > ./data/mPrimal240/c3/betaQ${betaQ}_struct${structured}_trial${trial}.txt \
    2>&1